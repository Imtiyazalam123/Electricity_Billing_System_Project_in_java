...
public class Project extends JFrame implements ActionListener{
    Project(){
        ...
        master.setFont(new Font("Senserif",Font.PLAIN,30));
        ...
        user.setFont(new Font("Senserif",Font.PLAIN,30));
        ...
        report.setFont(new Font("Senserif",Font.PLAIN,30));
        ...
        utility.setFont(new Font("Senserif",Font.PLAIN,30));
        ...
        exit.setFont(new Font("Senserif",Font.PLAIN,30));
